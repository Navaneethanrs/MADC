      ...
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-3">
          <a
            ...
            className="p-2.5 rounded-full border border-pink-500/30 bg-pink-500/10 text-pink-400 hover:text-white hover:bg-pink-500 hover:border-pink-500 transition-all duration-300 shadow-[0_0_12px_rgba(236,72,153,0.2)] cursor-pointer"
            title="Follow MADC on Instagram"
          >
